...
-(void) CallLoadScriptsAsModel:(NSString *)_scripts : (NSString*) libname :(NSString*)_fileName;
-(void) CallLoadScriptsAsModelWithPreDefine:(NSString*) uiRootViewAddress :(NSString *)_scripts :(NSString*)_fileName;
@end
